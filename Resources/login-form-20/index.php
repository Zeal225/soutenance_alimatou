		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="../../App/Http/controllers/authentification.php" method='post' class="signin-form">
		      		<div class="form-group">
		      			<input type="text"name='pseudo' class="form-control" placeholder="Login" required>
		      		</div>
	            <div class="form-group">
